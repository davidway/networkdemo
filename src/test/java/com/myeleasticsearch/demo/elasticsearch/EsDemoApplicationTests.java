package com.myeleasticsearch.demo.elasticsearch;

import com.myeleasticsearch.demo.domain.Item;
import com.myeleasticsearch.demo.respository.ItemRepository;
...
public class EsDemoApplicationTests {
    ...
    @Test
    public void test() {
        List<Item> item = itemRepository.findByTitle("OPPO");
     ...
     */
    @Test
    public void testNativeSearchQueryBuilder2() {
        NativeSearchQuery query = new NativeSearchQueryBuilder()
